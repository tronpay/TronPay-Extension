<template>
  <section>
    ...
    <section class="app-container">
      ...
      <qriously class="qr-code text-center mt20" foreground="#9328d4" :value="currentAccount.address ? currentAccount.address : ''" :size="130" />
      <div class="small-tip code text-center">{{currentAccount.address}}</div>
      <el-button class="full-btn mt40" type="primary" v-clipboard:copy="currentAccount.address"
